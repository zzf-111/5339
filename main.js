...
(function(){
  ...
  if(bgfx && !prefersReduced){
    ...
    const dustFar=mkDust(80,.6,1.4,.00010,.0002);   // 远景 · 小而慢
    const dustMid=mkDust(70,1.2,2.4,.0002,.0004);   // 中景
    const dustNear=mkDust(55,2.0,3.8,.0004,.0008);  // 近景 · 大而快
    // 亮星 —— 带淡蓝辉光
    const bright=Array.from({length:16},()=>({
